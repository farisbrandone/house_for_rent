...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-sky-200 pb-4 pt-4 dark:bg-dark lg:pb-4 lg:pt-[120px] mt-4">
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="mb-7 text-base text-body-color dark:text-dark-6">
                  <span className="text-xl font-extrabold text-[#003ce4] cursor-pointer">
                    mamaisonalouer.com
                  </span>{" "}
                  le site de reférence pour la recherche des offres immobilières
            ...
            {/*<LinkGroup header="Resources">
              <NavLink link="/#" label="Nos produits" />
            </LinkGroup>
            <LinkGroup header="Company">
              <NavLink link="/#" label="A propos de mamaisonalouer.com" />
              <NavLink link="/#" label="Contact & Support" />
            </LinkGroup>
            <LinkGroup header="Liens Rapides">
              <NavLink link="/#" label="Nos services" />
            </LinkGroup>*/}
